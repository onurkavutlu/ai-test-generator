...
public record LlmCallReport(
        String model,
        String callType,          // KARATE | SELENIUM | APPIUM | FAILURE_ANALYSIS | AGENT
    ...
    public int estimatedPromptTokens()    { return promptChars / 4; }
    public int estimatedResponseTokens()  { return responseChars / 4; }
}
