...
public class TestAutomationAgent extends AbstractLlmAgent {
    ...
    public AiAgentResult analyze(AiAgentContext context) {
        return runAgent(context, "Test Automation Agent",
                "Karate/Selenium/Appium için koşulabilir otomasyon kapsamı, locator/endpoint ve assertion öner.",
                """
                Otomasyon kapsamı frameworke göre koşulabilir dosya üretmeli: Karate feature, Selenium/Appium JUnit test.
