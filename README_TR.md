...
[![Testler](https://img.shields.io/badge/testler-640-brightgreen)](#kalite-kapıları)
...
Önkoşul: Docker Desktop ve Git. Ollama kullanılıyorsa servis/model, kurumun onaylı
kurulum yöntemiyle önceden sağlanmalıdır; bootstrap betiği yazılım veya model indirmez.
...
<details>
<summary><b>Docker kullanmadan yerel çalışma</b></summary>

Yalnızca uygulama çalışır; veri dosya tabanlı H2'de (`java.io.tmpdir` altında) tutulur.
Java 17+ gerekir, Maven gerekmez.

```bash
# Java 17 ve yerel Ollama/kurumsal LLM erişimi önceden sağlanmış olmalıdır.
